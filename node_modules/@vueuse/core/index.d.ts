...
import { Fn, MaybeRef, EventHookOn, ConfigurableEventFilter, ConfigurableFlush, RemovableRef, IntervalFnOptions, Pausable } from '@vueuse/shared';
 ...
 * @param options
 */
declare function onClickOutside(target: MaybeElementRef, handler: (evt: PointerEvent) => void, options?: ConfigurableWindow): (() => void) | undefined;
 ...
 * @param options
 */
declare function useAsyncState<T>(promise: Promise<T> | ((...args: any[]) => Promise<T>), initialState: T, options?: AsyncStateOptions): UseAsyncStateReturn<T>;
...
declare type ColorSchema = 'light' | 'dark' | 'auto';
interface UseDarkOptions extends StorageOptions<ColorSchema> {
    /**
