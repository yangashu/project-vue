<template>
  <div>
    <div style="margin-bottom: 10px">
      ...
      placeholder="输入经办人姓名"
    ></el-input>
    <span class="demonstration">退费日期：</span>
    <el-date-picker
      v-model="value1"
      type="daterange"
    ...
    <!-- 回显数据表格 -->
      ...
      <el-table-column type="selection" width="55"> </el-table-column>
        <el-table-column label="退费日期" prop="expenditureDate" />
        <el-table-column label="申请退费学员" prop="drawingName" />
        <el-table-column label="退费明细" prop="purpose" />
        <el-table-column label="退还金额" prop="expenditureMoney" />
